<?php
	...
	echo "<label for='ffd-modifications-discussion-quick-start-access_id'>" . elgg_echo("access") . "</label>";
	echo "<br />";
	echo elgg_view("input/hidden", array("name" => "access_id", "value" => $default_access, "id" => "ffd-modifications-discussion-quick-start-access_id"));
	echo "</div>";
